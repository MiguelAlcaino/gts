    ...
    implements Constants
{
    ...
    public TopMenuTempUser()
    {
        this.setBaseURI(RequestProperties.TRACK_BASE_URI());
        this.setPageName("top_menu_temp_user");
        ...
        throws IOException
    {
        ...
        final String       pageName   = TopMenuTempUser.this.getPageName();
        ...
        HTMLOutput HTML_CSS = new HTMLOutput() {
            public void write(PrintWriter out) throws IOException {
                ...
                WebPageAdaptor.writeCssLink(out, reqState, "TopMenu.css", TopMenuTempUser.this.getCssDirectory());
            }
        };
        ...
        HTMLOutput HTML_CONTENT = new HTMLOutput(CommonServlet.CSS_CONTENT_MENU, pageMsg) {
            public void write(PrintWriter out) throws IOException {
            	if (reqState.getCommandName().equals("add_temp_user")) {
