        ...
        HTMLOutput HTML_CONTENT = new HTMLOutput(CommonServlet.CSS_CONTENT_FRAME, m) {
            public void write(PrintWriter out) throws IOException {
            	...
            	if (reqState.getCommandName().equals("add_temp_user")) {
            		String submit = AttributeTools.getRequestString(request, "submit_add_temp_user", "");
            	...
            	*/
            	...
            	out.println("<hr />\n");
            	out.println("<form method='post' action='./Track?page=miguel&page_cmd=add_temp_user'>");
            		out.println("<table>");
            			out.println("<tbody>");
            				out.println("<tr>");
            					out.println("<td>");
							...
							*/
							...
							out.println("<tr>");
	        					...
	        					out.println("</td>");
	        					out.println("<td>");
	        						out.println("<input type='submit' value='Guardar' name='submit_add_temp_user' />");
	        					out.println("</td>");
							out.println("</tr>");
							out.println("</tbody>");
					out.println("<table>");
