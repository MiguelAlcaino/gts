    ...
    implements Constants
{
  ...
  //public  static final String PROP_legacyLAF              = "legacyLAF";
    ...
    public TempUserLogin()
    {
        ...
        super.setPageName("temp_user_login"); // 'super' required here
        this.setPageNavigation(new String[] { "temp_user_login" });
      ...
      //final boolean legacy = this.getProperties().getBoolean(PROP_legacyLAF,false);
        ...
        HTMLOutput HTML_CSS = new HTMLOutput() {
            public void write(PrintWriter out) throws IOException {
                String cssDir = TempUserLogin.this.getCssDirectory(); 
        ...
        HTMLOutput HTML_CONTENT = new HTMLOutput(cssAccountLogin, pageMsg) {
            public void write(PrintWriter out) throws IOException {
            	...
            	if (reqState.getCommandName().equals("login_action")) {
            		String temp_user_email = AttributeTools.getRequestString(req, "temp_user_email", "");
            		String tracking_number_temp_password = AttributeTools.getRequestString(req, "temp_user_password", "");
            		try{
                    ...
                    String vsepImg = legacy? null : TempUserLogin.this.getProperties().getString(PROP_VSeparatorImage,null);
                    if (!StringTools.isBlank(vsepImg)) {
                        String W = TempUserLogin.this.getProperties().getString(PROP_VSeparatorImage_W,null);
                        String H = TempUserLogin.this.getProperties().getString(PROP_VSeparatorImage_H,null);
                    ...
                    out.println("<form name='"+FORM_LOGIN+"' method='post' action='./Track?page=temp_user_login&page_cmd=login_action' target='"+target+"'>");
                    ...
                    // Email field
                        ...
                        out.print("  <tr><td class='accountLoginFieldLabel'>Email</td>");
                        out.print(      "<td class='accountLoginFieldValue'><input id='temp_user_email' class='"+CommonServlet.CSS_TEXT_INPUT+"' type='email' name='temp_user_email' size='24' maxlength='32' /></td></tr>");
                        out.print("\n");
                        focusFieldID = fldID;
                    
                    // password field
                        out.print("  <tr>");
                        out.print(    "<td class='accountLoginFieldLabel'>Password </td>");
                        out.print(    "<td class='accountLoginFieldValue'><input class='"+CommonServlet.CSS_TEXT_INPUT+"' type='password' name='temp_user_password' value='' size='24' maxlength='32' /></td>");
                        out.print(  "</tr>\n");
