...
__copyright__ = 'Copyright (c) 2014, ServerPilot'
...
if sys.version_info[:2] < (2, 7):
    print('*' * 80)
    print('Sorry, ServerPilot does not support your operating system.')
    print('')
    print('The operating systems we support are: ')
    print('  * Ubuntu 12.04')
    print('*' * 80)
    sys.exit(1)
...
DISTRO_UBUNTU_RELS = ['12.04', '14.04']
...
class Installer(object):
    ...
    def get_distro_and_version(self):
        try:
            ...
            print(color.red('*' * 80))
            print(color.bold('Sorry, ServerPilot does not support your operating system.'))
            print('')
            print(color.bold('The operating systems we support are: '))
            for rel in DISTRO_UBUNTU_RELS:
                print(color.bold('  * Ubuntu: {}'.format(rel)))
            print(color.red('*' * 80))
            raise
    ...
    def check_architecture(self):
        ...
        if self.arch != 'x86_64':
            ...
            print(color.red('ServerPilot currently only supports 64-bit systems.'))
            print(color.red('Your system appears to be {0}.'.format(self.arch)))
    ...
    def check_kernel(self):
        ...
        # 3.2 is the earliest version shipped with Ubuntu 12.04.
    ...
    def ask_server_ident(self):
        ...
        if not self.serverid or not self.apikey:
            ...
            print(color.bold("You can get these by logging in to https://serverpilot.com and"))
    ...
    def install_packages(self):
        ...
        # We're actually serious that we only support Ubuntu 12.04. If you are
        ...
        # please take us seriously and just use Ubuntu 12.04. Thanks!
